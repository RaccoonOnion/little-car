...
# for debugging
set_property IOSTANDARD LVCMOS33 [get_ports {left_detect_on_1s}]
set_property PACKAGE_PIN F6 [get_ports {left_detect_on_1s}]

set_property IOSTANDARD LVCMOS33 [get_ports {left_detect_off_1s}]
set_property PACKAGE_PIN G4 [get_ports {left_detect_off_1s}]

set_property IOSTANDARD LVCMOS33 [get_ports {right_detect_on_1s}]
set_property PACKAGE_PIN G3 [get_ports {right_detect_on_1s}]

set_property IOSTANDARD LVCMOS33 [get_ports {right_detect_off_1s}]
set_property PACKAGE_PIN J4 [get_ports {right_detect_off_1s}]
